...
export async function generateContractPdf(
  ...
  if (options.includeLegal) {
    ...
    if (data.clientProvidesAudio && !options.contractLegalText) {
      clausesToDraw.push({
        n: "DÉCIMA OCTAVA",
