    ...
    >
      ...
      <div className="space-y-4 text-justify mb-12">
        ...
        <div className="border-t pt-4 space-y-4 text-[10.5px]">
          ...
          <p><span className="font-bold">DÉCIMA SEGUNDA.-</span> El precio por HORA EXTRA (sujeto a disponibilidad de la agrupación y staff) será de $5,000.00 MN por hora adicional de show en vivo.</p>
          ...
          <p><span className="font-bold">DÉCIMA SEXTA.- CLÁUSULA DE AUDIO INNEGOCIABLE:</span> Para salvaguardar la fidelidad acústica y el estándar de excelencia de “VENDETTA”, la agrupación opera de manera innegociable con su propio sistema de audio profesional, microfonía y personal técnico de ingeniería. El servicio técnico de sonido no es fraccionable ni sujeto a descuento comercial, y queda prohibida la conexión o sustitución en equipos ajenos o de recintos, salvo en eventos masivos catalogados como “Festival” que cuenten con rider técnico profesional homologado y aprobado previamente por escrito.</p>
