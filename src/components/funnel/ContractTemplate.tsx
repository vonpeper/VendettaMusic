    ...
    >
      ...
      <div className="space-y-4 text-justify mb-12">
        ...
        <div className="border-t pt-4 space-y-4 text-[10.5px]">
          ...
          <p><span className="font-bold">DÉCIMA SEXTA.- GARANTÍA TÉCNICA Y PRODUCCIÓN SONORA:</span> Con el objetivo de asegurar la fidelidad acústica, el balance sonoro y la más alta calidad en la ejecución artística de “VENDETTA”, el servicio incluye el equipamiento de audio profesional, microfonía y personal de ingeniería que la agrupación requiere para su presentación. Dicha producción técnica forma parte integral del estándar de calidad de la agrupación y no está sujeta a fraccionamiento ni deducción. En eventos masivos catalogados formalmente como “Festival”, la agrupación podrá operar con el rider técnico profesional homologado provisto por la producción del festival.</p>
