  ...
  return (
    <Tabs defaultValue="base-packages" className="space-y-8">
      ...
      <TabsContent value="customization" className="space-y-10 outline-none">
        ...
        <Card className="bg-card border border-border/40 shadow-lg rounded-2xl">
          <CardHeader className="bg-muted/30 border-b border-border/10 p-5">
            <div className="flex flex-col sm:flex-row justify-between sm:items-center gap-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <CardTitle className="text-base font-bold text-foreground uppercase tracking-wider">Tarifa y Límites de la Banda</CardTitle>
              ...
              <Button 
                ...
                disabled={loading}
                className="gap-2 bg-blue-600 hover:bg-blue-700 text-white h-10 px-5 font-bold text-xs uppercase tracking-wider w-full sm:w-auto"
              >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input 
                    ...
                    className="pl-7 bg-background h-10 text-sm font-semibold w-full border border-border/80 focus:border-blue-600"
                  />
                </div>
              </div>
              ...
              <div className="space-y-2">
                ...
                <Input 
                  ...
                  className="bg-background h-10 text-sm font-semibold w-full border border-border/80 focus:border-blue-600"
                />
              </div>
