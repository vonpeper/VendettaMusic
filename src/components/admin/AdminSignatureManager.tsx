      ...
      {signature ? (
        <div className="space-y-6">
          ...
          >
             ...
             <div className="absolute bottom-2 right-4 text-[8px] opacity-40 text-foreground font-black">v8.0</div>
             {signature ? (
          ...
          <div className="p-6 pb-0" style={{ touchAction: "none" }}>
            <DialogHeader>
              <DialogTitle className="text-2xl font-black text-foreground uppercase tracking-tight flex items-center gap-3">
                ...
                Registro de Firma <span className="text-[10px] bg-green-500 text-white px-2 py-0.5 rounded-full">v8.0</span>
              </DialogTitle>
