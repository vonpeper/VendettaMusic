...
export const metadata: Metadata = {
  ...
  description: "Conoce nuestros paquetes musicales (Essential, Premium y Acústico) para tu boda o evento. Cotiza en línea para disponibilidad inmediata.",
  alternates: {
    canonical: "/paquetes",
  }
}
      ...
      <section className="bg-black py-24 md:py-32 border-b border-white/10">
        <div className="container px-4 text-center">
          ...
          <p className="max-w-2xl mx-auto text-lg text-muted-foreground">
            Configuramos el show ideal según la escala de tu fiesta. Cotiza en línea en 2 minutos y asegura la fecha de tu evento.
          </p>
        </div>
      </section>
        ...
        <div className="container px-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {paquetes.map((pkg, i) => (
              ...
              >
                ...
                <Link href="/cotizar" className="w-full mt-auto">
                  <Button 
                    className={`w-full font-bold gap-2 cursor-pointer ${
                      pkg.popular 
                        ? "bg-primary hover:bg-primary/90 text-white shadow-lg shadow-primary/20" 
                        : "bg-white/10 hover:bg-primary text-white border border-white/20 hover:border-primary"
                    }`}
                  >
          ...
          <div className="mt-24 max-w-3xl mx-auto text-center border-t border-white/10 pt-16">
            ...
            <p className="text-muted-foreground mb-8">
              Platícanos los requerimientos de tu evento. Estructuramos el show perfecto con horas extras, producción extendida o requerimientos especiales.
            </p>
            <Link href="/cotizar" className="inline-block">
              <Button size="lg" className="px-10 font-bold bg-primary hover:bg-primary/90 text-white gap-2 cursor-pointer">
