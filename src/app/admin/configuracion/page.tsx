          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <section className="space-y-6 pt-12 mt-12 border-t border-border/60">
              <div className="flex items-center gap-4 mb-2">
                ...
                <div>
                  <h2 className="text-2xl font-heading font-bold text-foreground underline decoration-[#E91E63]">CONTROL DE FIRMA v8.0</h2>
                  <p className="text-sm text-muted-foreground font-black text-[#E91E63]">ACTUALIZACIÓN FORZADA v8.0 - DOCKER REBUILD</p>
                </div>
              </div>
