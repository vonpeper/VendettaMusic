  ...
  try {
    ...
    const booking = await db.bookingRequest.create({
      data: {
        ...
        state:         state || "México",
        isOutsideZone: viaticosResult.viaticosAmount > 0 || viaticosResult.requiresManualQuote || body.requiresManualQuote === true,
        viaticosAmount: viaticosResult.viaticosAmount || 0,
        distanceKm:    viaticosResult.distanceKm,
        durationSec:   viaticosResult.durationSec,
        tollCost:      viaticosResult.tollCost,
        fuelCost:      viaticosResult.fuelCost,
        requiresManualQuote: viaticosResult.requiresManualQuote || body.requiresManualQuote === true,
